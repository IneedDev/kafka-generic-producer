...
/**
 * <p>Java class for createParcels complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="createParcels"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="parcel" type="{http://services.szop.inpost.pl/}parcelApiVO" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "createParcels", propOrder = {
    "parcel",
    "parcelAttribute"
})
public class CreateParcels {

    protected List<ParcelApiVO> parcel;
     ...
     * 
     */
    public List<ParcelApiVO> getParcel() {
        if (parcel == null) {
            parcel = new ArrayList<ParcelApiVO>();
        }
        return this.parcel;
    }
